...
| 13 | **13.1 CI/CD GitHub Actions (Done — pipeline CI : portes dures Vitest+build, e2e opt-in débloquant 3.6/5.2)** · 13.2 déploiement Vercel · 13.3 monitoring Sentry · 13.4 backups DB · **13.5 rate-limiting** | DevOps / Sécu infra |
