...
| 11 | 11.1 consentement RGPD **(Done — brique consentement)** · 11.2 droit à l'oubli/export **(Done — portabilité art. 20 + effacement art. 17 ; réserve prod 9.x NON levée)** · 11.3 journal d'audit · 11.4 chiffrement | RGPD / Sécurité |
